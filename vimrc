...
" single quote is a comment comment
"" is a comment of code that can be uncommented
" ============================================
...
" Req curl ie sudo apt-get install curl
...
" f to fold block or F to fold entire code
set nofoldenable
